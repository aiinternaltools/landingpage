...
import { REPORT_AUDIT_AREAS } from "@/components/automation-audit/report/report-template-sections";
...
export function ScoreRadarChart({ scores }: ScoreRadarChartProps) {
  ...
  return (
    <div className="h-72 w-full" aria-label="Radar chart of automation scores">
