...
export function AutomationAuditForm({
  ...
  return (
    ...
    >
      <label htmlFor="automation-audit-url" className="sr-only">
        Website URL
      </label>
      <div className="flex flex-col gap-3 sm:flex-row">
        <input
          id="automation-audit-url"
          type="url"
          inputMode="url"
      ...
      {!compact ? (
        <>
          ...
          <p className="mt-3 text-xs leading-relaxed text-muted">
            Scans your public site to infer business model, detect visible tools, and
            recommend automation directions.
          </p>
        </>
      ) : null}
    </form>
