...
import { aiSocialMediaAssistant } from "@/content/use-cases/ai-social-media-assistant";

export const metadata: Metadata = {
  title: aiSocialMediaAssistant.metadata.title,
  description: aiSocialMediaAssistant.metadata.description,
};
...
export default function AiSocialMediaAssistantPage() {
  const content = aiSocialMediaAssistant;
